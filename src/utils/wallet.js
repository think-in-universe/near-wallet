...
export const WALLET_CREATE_NEW_ACCOUNT_FLOW_URLS = ['create', 'linkdrop', 'set-recovery', 'setup-seed-phrase', 'recover-account', 'recover-seed-phrase', 'sign-in-ledger', 'fund-create-account']
